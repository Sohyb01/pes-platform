...
export default function Page() {
  return (
    <main className="w-full max-w-none overflow-hidden">
      <section className="py-20 pt-[160px] bg-background relative">
        <div className="container flex flex-col items-center gap-16">
          <h1 className="text-foreground text-h1 header text-start w-full">
            Legal
          </h1>
          {/* Privacy Policy */}
          <div className="flex flex-col text-start w-full text-foreground gap-8">
            <h2 className="header text-h2">Privacy Policy</h2>
            <p>
              This Privacy Policy describes how your personal information is
              collected, used, and shared when you visit or make a purchase from
              PES (the site).
            </p>
            <h3 className="header text-h3">Personal Information We Collect</h3>
            ...
            <h3 className="header text-h3">Do Not Track</h3>
            <p>
            ...
            <h3 className="header text-h3">Your Rights</h3>
            <p>
            ...
            <h3 className="header text-h3">Data Retention</h3>
            <p>
            ...
            <h3 className="header text-h3">Changes</h3>
            <p>
            ...
            <h3 className="header text-h3">Contact Us</h3>
            <p>
              For more information about our privacy practices, if you have
              questions, or if you would like to make a complaint, please
              contact us by e-mail at info@pes-edu.com
            </p>
          </div>
          {/* Terms of Service */}
          <div className="flex flex-col text-start w-full text-foreground gap-8">
            <h2 className="header text-h2">Terms of Service</h2>
            <h2 className="header text-h3">Overview</h2>
            <p>
              This website is operated by PES. Throughout the site, the terms
              “we”, “us” and “our” refer to PES. PES offers this website,
            ...
            {/*  */}
            <h2 className="header text-h3">Section 1 - Online Store Terms</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 2 - General Condition</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 7 - Optional Tools</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 8 - Third-Party Links</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 12 - Prohibited Uses</h2>
            <p>
            ...
            <p>
              In no case shall PES, our directors, officers, employees,
            ...
            {/*  */}
            <h2 className="header text-h3">Section 14 - Indemnification</h2>
            <p>
              You agree to indemnify, defend and hold harmless PES and our
            ...
            {/*  */}
            <h2 className="header text-h3">Section 15 - Severability</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 16 - Termination</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 17 - Entire Agreement</h2>
            <p>
            ...
            {/*  */}
            <h2 className="header text-h3">Section 19 - Contact Information</h2>
            <p>
