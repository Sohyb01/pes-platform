...
import { exampleAssignments, exampleExams } from "@/lib/data";
import { compareAsc, differenceInDays, format } from "date-fns";
import { Calendar, NotebookPen, TriangleAlert, User } from "lucide-react";
...
const getDueExams = async () => {
  return exampleExams.filter((exam) => compareAsc(exam.timestamp, new Date()));
};
