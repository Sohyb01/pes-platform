  ...
  return variant === "week" ? (
    <div className="flex flex-col gap-2">
      <div className="flex gap-4 flex-col md:flex-row flex-wrap py-2 items-end">
        {/* 1st */}
        <div className="md:min-w-[280px] lg:max-w-[25vw] grow flex items-center px-4 py-5 rounded-[0.5rem] border-border border-[1px] bg-primary text-primary-foreground w-full h-fit">
        ...
        {/* 2nd */}
        <div className="md:min-w-[280px] lg:max-w-[25vw] grow flex items-center px-4 py-4 rounded-[0.5rem] border-border border-[1px] bg-secondary text-secondary-foreground w-full h-fit">
        ...
        {/* 3rd */}
        <div className="md:min-w-[280px] lg:max-w-[25vw] grow flex items-center px-4 py-3 rounded-[0.5rem] border-border border-[1px] bg-success text-success-foreground w-full h-fit">
