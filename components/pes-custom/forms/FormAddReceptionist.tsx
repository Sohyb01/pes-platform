...
const FormAddReceptionist = ({
  ...
  const form = useForm<TFormSchemaAddReceptionist>({
    resolver: zodResolver(FormSchemaAddReceptionist),
    defaultValues,
  });
  ...
  const onSubmit = async (data: TFormSchemaAddReceptionist) => {
...
export default FormAddReceptionist;
